...
col_names <- list(
    ...
    "detail.id" = "PowerInsight Order Detail ID",
    "detail.seq" = "Detail Sequence",
    ...
    "dispense.datetime" = "Dispense Date and Time",
    "dispense.location" = "Dispense From Location",
    "dispense.type" = "Dispense Event Type",
    ...
    "event.datetime" = "Clinical Event Date Result",
    ...
    "md.start.datetime" = "Date and Time - Phys Begin Effective",
    "md.stop.datetime" = "Date and Time - Phys End Effective",
    ...
    "order.dc.datetime" = "Date and Time - Discontinue Effective",
    ...
    "review.type" = "Review type flag",
    "review.seq" = "Review Seq",
    "reviewer" = "Review Personnel",
